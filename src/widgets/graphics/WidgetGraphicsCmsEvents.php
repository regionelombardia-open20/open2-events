...
/**
 * Class WidgetGraphicsCmsEvents
 * @package open20\amos\events\widgets\graphics
 */
class WidgetGraphicsCmsEvents extends WidgetGraphic
{
    /**
    ...
    public function init()
    {
        ...
        $this->setLabel(AmosEvents::t('amosevents', '#widget_graphic_cms_last_events_label'));
        $this->setDescription(AmosEvents::t('amosevents', '#widget_graphic_cms_last_events_description'));
    }
    ...
    public function getHtml()
    {
        ...
        if (count($eventsForCarousel) > 0) {
            return $this->render('ultime_events_cms', [
