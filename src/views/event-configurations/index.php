 ...
 * @var open20\amos\events\models\search\EventConfigurationsSearch $model
*/

$this->title = Yii::t('amoscore', 'Event Configurations');
$this->params['breadcrumbs'][] = ['label' => '', 'url' => ['/events']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="event-configurations-index">
