 ...
 *
 * This is the base-model class for table "related_event_mm".
 *
 * @property integer $id
 ...
 * @package open20\amos\events\models\base
 */
abstract class RelatedEventMm extends Record
{
    /**
    ...
    public function attributeLabels()
    {
        return ArrayHelper::merge(parent::attributeLabels(), [
            ...
            'main_event_id' => AmosEvents::t('amosevents', '#main_event'),
            'related_event_id' => AmosEvents::t('amosevents', '#related_event'),
